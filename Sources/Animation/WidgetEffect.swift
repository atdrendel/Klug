    ...
    var body: some View {
        ZStack {
            ...
            HStack(spacing: 40){
                ...
                .animation(Animation.easeInOut(duration: 0.15).repeatForever(autoreverses: true), value: wiggleCalendar)
                .task {
                ...
                .rotation3DEffect(.degrees(5), axis: (x: 0, y: -5, z: 0))
                .animation(Animation.easeInOut(duration: 0.15).repeatForever(autoreverses: true), value: wiggleWeather)
                .task {
                     // Final rotation angle
                    wiggleWeather = 2.5
                }
...
#if DEBUG
struct WidgetEffect_Previews : PreviewProvider {
